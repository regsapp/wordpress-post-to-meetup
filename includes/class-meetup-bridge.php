...
class Meetup_Bridge {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Meetup_Bridge_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	 ...
	 * - Meetup_Bridge_Public. Defines all hooks for the public side of the site.
	 *
	...
	private function load_dependencies() {
		 ...
		 * side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-meetup-bridge-public.php';
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Meetup_Bridge_Public( $this->get_plugin_name(), $this->get_version() );
	 ...
	 *
	 * @since     1.0.0
	 * @return    Meetup_Bridge_Loader    Orchestrates the hooks of the plugin.
	 */
